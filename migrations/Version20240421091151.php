 ...
 */
final class Version20240421091151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6970EB0FA76ED395 ON reviews (user_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6970EB0FA76ED395 ON reviews');
